...
# Load model dengan handling error jika file tidak ditemukan
try:
...
st.write("""
Aplikasi ini memprediksi apakah pinjaman akan disetujui berdasarkan input dari pengguna.
""")

# Form input data calon peminjam
...
if st.button('Prediksi Persetujuan Pinjaman'):
    # Buat DataFrame dari input pengguna dengan konversi kategori ke angka
    input_data = {
